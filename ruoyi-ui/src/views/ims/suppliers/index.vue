    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ims:suppliers:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ims:suppliers:export']"
        >导出
        </el-button>
      </el-col>
...
<script>
import {listSuppliers, getSuppliers, delSuppliers, addSuppliers, updateSuppliers} from "@/api/ims/suppliers";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ims/suppliers/export', {
        ...this.queryParams
