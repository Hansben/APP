<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="商品所属类别" prop="category">
        <el-select v-model="queryParams.category" placeholder="请选择商品所属类别" clearable>
          <el-option
            v-for="dict in dict.type.ims_product_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ims:products:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ims:products:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="productsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品所属类别" align="center" prop="category">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.ims_product_type" :value="scope.row.category"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品所属类别" prop="category">
          <el-select v-model="form.category" placeholder="请选择商品所属类别">
            <el-option
              v-for="dict in dict.type.ims_product_type"
              :key="dict.value"
              :label="dict.label"
...
<script>
import { listProducts, getProducts, delProducts, addProducts, updateProducts } from "@/api/ims/products";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ims/products/export', {
        ...this.queryParams
